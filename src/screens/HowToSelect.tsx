  ...
  },
  {
    ...
    subtitle: (
      <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 4 }}>
        <span style={{ color: IVORY_SUBTLE, fontSize: 14, lineHeight: '20px' }}>Tap the</span>
        <span className="material-symbols-rounded" style={{ fontSize: 18, color: colors.ivory }}>info</span>
        <span style={{ color: IVORY_SUBTLE, fontSize: 14, lineHeight: '20px' }}>info icon</span>
      </div>
    ),
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" style={{ flexShrink: 0 }}>
        <path d="M36.047 33.9976C37.4324 27.2769 34.7672 27.026 33.2614 27.7406C32.5155 25.4237 30.3163 25.9536 29.3099 26.5082C27.9044 24.6014 26.2594 25.4187 25.6126 26.0656L25.475 15.4889C25.462 14.4887 24.6956 13.6599 23.6994 13.5688C22.5815 13.4665 21.6076 14.3252 21.5689 15.4471L21.1533 27.5129M21.1533 27.5129L20.3902 33.9968M21.1533 27.5129C17.5068 31.1472 15.5255 35.5886 18.997 38.4639C21.5084 40.5439 22.5007 43.2544 22.801 45.2309" stroke={colors.ivory} strokeWidth="1.28571" strokeLinecap="round" strokeLinejoin="round" />
        <path opacity="0.4" d="M18.7506 18.0251C18.0214 17.0466 17.5898 15.8333 17.5898 14.5192C17.5898 11.2756 20.2193 8.64618 23.4629 8.64618C26.7065 8.64618 29.3359 11.2756 29.3359 14.5192C29.3359 15.8333 28.9044 17.0466 28.1752 18.0251M16.84 21.6345C14.9342 19.8599 13.7422 17.3288 13.7422 14.5192C13.7422 9.1509 18.0941 4.79901 23.4624 4.79901C28.8307 4.79901 33.1826 9.1509 33.1826 14.5192C33.1826 17.0371 32.2252 19.3314 30.6547 21.058" stroke={colors.ivory} strokeWidth="1.28571" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
] as const;
    ...
    <div style={{ position: 'absolute', inset: 0, zIndex: 50 }}>
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          animation: closing ? 'slideDownContent 300ms ease-in both' : undefined,
        }}
      >
        {/* Close button */}
        <button
        ...
        >
          {GESTURES.map(({ label, subtitle, icon }, i) => (
            <>
              {i > 0 && (
                <div
                  key={`divider-${i}`}
                  style={{
                    ...
                    animation: `fadeIn 200ms ease-out ${160 + i * 160}ms both`,
                  }}
                />
              )}
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  gap: 4,
                  animation: `fadeInUp 200ms ease-out ${240 + i * 160}ms both`,
                }}
              >
                {icon}
                <div style={{ flex: 1 }}>
                  <p style={{ color: colors.ivory, fontSize: 16, fontWeight: 600, lineHeight: '22px', margin: 0 }}>
                    {label}
                  </p>
                  {subtitle}
                </div>
